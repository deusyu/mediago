...
3. 删除 apiKey 字段中的值。`,
  ...
  preparing: "准备下载",
  live: "直播",
  engineRunning: "下载引擎运行中",
  manageAllTasks: "管理你的全部下载任务",
  completedTasksDesc: "已完成的下载，可直接播放或清理",
  personalizeExperience: "个性化你的下载体验",
  desktopBadge: "桌面端",
  batchStart: "批量开始",
  emptyDownloadsTitle: "还没有下载任务",
  emptyDownloadsSub: "点击新建，粘贴链接即可开始下载",
  emptyCompletedTitle: "暂无已完成任务",
  emptyCompletedSub: "完成的下载会出现在这里",
  singleDownload: "单条下载",
  modalSub: "粘贴链接，选择保存位置即可",
  optional: "（可选）",
  parsePreview: "解析预览",
  validCount: "{{count}} 条有效",
  invalidCount: "{{count}} 条待修正",
  batchEmptyHint: "在上方粘贴链接，这里会实时显示解析结果",
  sharedHeaders: "共享 Headers（应用到全部任务）",
  convertSubtitle: "将下载好的视频转换为音频",
  converting: "转换中",
  done: "已完成",
  failed: "失败",
  qualityHigh: "高",
