export const it = {
  ...
  live: "LIVE",
  engineRunning: "Motore di download attivo",
  manageAllTasks: "Gestisci tutte le tue attività di download",
  completedTasksDesc: "Download completati — riproduci o pulisci",
  personalizeExperience: "Personalizza la tua esperienza di download",
  desktopBadge: "Desktop",
  batchStart: "Avvia selezionati",
  emptyDownloadsTitle: "Nessuna attività di download",
  emptyDownloadsSub: "Clicca nuovo e incolla un link per iniziare",
  emptyCompletedTitle: "Niente di completato",
  emptyCompletedSub: "I download completati appaiono qui",
  singleDownload: "Singolo",
  modalSub: "Incolla un link e scegli dove salvare",
  optional: "(opzionale)",
  parsePreview: "Anteprima analisi",
  validCount: "{{count}} validi",
  invalidCount: "{{count}} da correggere",
  batchEmptyHint: "Incolla i link sopra — le righe analizzate appaiono qui",
  sharedHeaders: "Header condivisi (applicati a tutti)",
  convertSubtitle: "Converti i video scaricati in audio",
  ...
  mobile: "Mobile",
  desktop: "Desktop",
  sniffResource: "Rilevamento risorse",
